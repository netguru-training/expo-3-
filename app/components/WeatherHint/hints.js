...
const TEMP_THRESHOLD_HOT = 30; // [°C]
const RAIN_THRESHOLD = 5; // [mm]
const SNOW_THRESHOLD = 10; // [mm]
const WIND_SPEED_THRESHOLD = 10; // [m/s]
...
const DEFAULT_HINT = 'Just another great day!';
