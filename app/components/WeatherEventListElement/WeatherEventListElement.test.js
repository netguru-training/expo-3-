...
describe('Components: WeatherEventListElement', () => {
  ...
  const wrapper = shallow(<WeatherEventListElement {...defaultProps} />);
  ...
  it('Should receive proper props', () => {
    expect(wrapper.props().children[0].props.children[0].props.headerInfo).toBe(
      defaultProps.headerInfo
    );
    expect(wrapper.props().children[0].props.children[0].props.imageUrl).toBe(
      defaultProps.imageUrl
    );
    expect(wrapper.props().children[0].props.children[0].props.footerInfo).toBe(
      defaultProps.footerInfo
    );
  });

  it('Should show proper message when no events', () => {
    expect(wrapper.props().children[0].props.children[1].props.children).toBe(
  ...
  it('Should show proper message when number of events > 0', () => {
    ...
    const newWrapper = shallow(<WeatherEventListElement {...props} />);
    expect(newWrapper.props().children[0].props.children[1].props.children).toBe(
